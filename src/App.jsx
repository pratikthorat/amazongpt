      ...
      <main class="cred-main">
        ...
        <div class="cred-product-list">
          ...
          <div class="cred-product-image">
            <iframe src="//c.amazon-adsystem.com/aax2/assoc_lra.html?tag=megha1706-21&amp;c=100&amp;src=302&amp;sz=300x250" width="300" height="250"  border="0" marginwidth="0" style={{ border: 'none' }} frameborder="0" title="amazon"></iframe>
            </div>
          ...
          <div class="cta">
              <p>Start Shopping on Amazon</p>
               <div class="cred-product-image">
               <iframe src="//c.amazon-adsystem.com/aax2/assoc_lra.html?tag=megha1706-21&amp;c=100&amp;src=302&amp;sz=300x250" width="300" height="250"  border="0" marginwidth="0" style={{ border: 'none' }} frameborder="0" title="amazon2"></iframe>
               </div>
          </div>
                </div>
              </div>
